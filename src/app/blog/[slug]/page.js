...
export default async function DetailBlog({params}){
    ...
    return(
        <>
           <div className="bg-cover bg-no-repeat w-full md:h-[600px] h-[300px]" style={{backgroundImage:`url(${""})`}}>
            <div className="bg-cover bg-[url('/images/solution/banner/rectangle14.png')] w-full h-full z-10 text-center items-center">
                ...
                <div className="flex justify-center pb-16">
                    <Link href="#" className="border-r-black text-white text-xs md:text-lg font-bold uppercase ">{"asdasd"}</Link>
                    <hr className="border-transparent w-0.5 md:h-8 h-3 bg-white md:mx-4 mx-1"/>   
                    <Link href="#" className="border-r-black text-white text-xs md:text-lg font-bold">{""}</Link>
                </div>
                <h1 className="uppercase md:text-2xl text-lg font-bold text-white md:pb-14 pb-5 mx-auto">{""}</h1>
            </div>
        </div>
        <div >
            <img src={"/images/news/story/story.png"} className="w-full md:w-4/12 md:h-96 h-64 md:p-10 p-4 float-left"/>
            <h4 className="font-normal md:text-lg text-sm md:m-16 m-4 md:pb-72">
             {"sadsd ddddddddddddd ddddddddddddddddddddddddddddddddddd ddddddddddddddddddd dddddddddd dddddd ddd ddddddddd ddd dddddddddd dfffff fffff ffffff ff fssssssssss fsssss fssssssss ff feeee eeee e"}
            </h4>
        </div>
        <br/>
        <div style={{backgroundImage:'url(/images/news/rectangle18.png)'}} className="bg-cover bg-no-repeat w-full md:h-20 h-14 text-center py-5">
           <h1 className="mx-auto my-auto text-center text-2xl font-bold text-white md:pb-10 pb-7">OTHER POSTS</h1>
        </div>
